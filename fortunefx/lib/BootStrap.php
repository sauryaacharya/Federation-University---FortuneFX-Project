...
class BootStrap {
    ...
    public function storeCoreObject() {
        ...
        $this->registry->storeObject("form_validation", "FormValidation");
        $this->registry->storeObject("exception", "Exceptions");
        $this->registry->storeObject("loader", "Loader");
        //$this->registry->storeObject("cart", "Cart");
        $this->registry->storeObject("pagination", "Pagination");
