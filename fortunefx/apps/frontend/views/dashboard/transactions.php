<script type="text/javascript">
    ...
    $('#dep_trans_table').DataTable({
        "order": [[ 0, "desc" ]],
        "ajax":{
            "url" : "/fortunefx/ajaxservice/deposittransactions",
            "dataSrc" : "deposit_transactions"
        },
        "language": {
...
<div id="left_sidebar" class="sidebar_grid">
    <div id="trans_detail" class="sidebar_cont">
      <h3 style="font-family:Arial;color:#f2f2f2;background:#4d4d4d;padding:5px 0px 5px 5px;">My Transactions History</h3>
      <div id="trans_detail_panel">
          <h4 style="font-family:Arial;color:#222;">Deposit Transactions</h4>
          <div style="border-top:1px solid #a6a6a6;margin-top:5px;margin-bottom:5px;"></div>
          
          
          <div class="trans_panel" id="dep_panel">
              <table id="dep_trans_table" class="dep_tbl" cellspacing="0" width="100%">
          ...
          <br/>
          <h4 style="font-family:Arial;color:#222;">Order Transactions</h4>
          <div style="border-top:1px solid #a6a6a6;margin-top:5px;margin-bottom:5px;"></div>
